<?php /* Smarty version 2.6.11, created on 2023-07-26 09:07:21
         compiled from custom/modules/ECT_Class/tpls/editaddstudent.tpl */ ?>
<?php echo '
    <style type="text/css">
        .custom-popup {
            position: fixed;
...
?>
            <tr>
                <td class="checkbox-column">
                    <input type="checkbox" name="selectedStudents[]" value="<?php echo $this->_tpl_vars['student']['student_id']; ?>
" data-id="<?php echo $this->_tpl_vars['student']['primary_id']; ?>
">
                </td>
                <td class="name-column"><?php echo $this->_tpl_vars['student']['student_name']; ?>
</td>
                <td class="id-column"><?php echo $this->_tpl_vars['student']['student_custom_id']; ?>
</td>
                <td class="course-column"><?php echo $this->_tpl_vars['student']['student_course']; ?>
</td>
                <td class="expected-day-column"><?php echo $this->_tpl_vars['student']['student_expectedday']; ?>
</td>
            </tr>
