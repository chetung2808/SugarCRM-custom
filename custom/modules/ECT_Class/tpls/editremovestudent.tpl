...
<div id="removeStudentPopup" class="custom-popup hide">
    ...
    <table>
        ...
        <tbody>
        {foreach from=$studentListtt item=studenttt}
            <tr>
                <td class="checkbox-column">
                    <input type="checkbox" name="selectedRemoveStudents[]" value="{$studenttt.student_id}" data-id="{$studenttt.primary_id}">
                </td>
                <td class="name-column">{$studenttt.student_name}</td>
                <td class="id-column">{$studenttt.student_custom_id}</td>
                <td class="course-column">{$studenttt.student_course}</td>
                <td class="expected-day-column">{$studenttt.student_expectedday}</td>
            </tr>
        {/foreach}
        </tbody>
    </table>
